...
const ImageWithSkeleton = ({ src, alt, className }: { src: string; alt: string; className?: string }) => {
    ...
    return (
        <div className="relative w-full h-full">
            {!loaded && <Skeleton className="absolute inset-0 w-full h-full bg-gray-200" />}
            <img
                src={src}
                alt={alt}
                className={cn(className, !loaded && "opacity-0 transition-opacity duration-300", loaded && "opacity-100 transition-opacity duration-300")}
...
const ListingsScreen = () => {
    ...
    return (
        <div className="min-h-screen lg:h-[calc(100vh-64px)] bg-gray-50 pb-20 lg:pb-0 font-sans flex flex-col lg:flex-row lg:overflow-hidden">
            {/* ─── LEFT PANEL: Search & Feed ─── */}
            <div className="w-full lg:w-[55%] xl:w-[50%] flex flex-col h-full lg:h-full lg:overflow-y-auto">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="relative h-48 w-full bg-gray-100">
                                        ...
                                        />
                                        {/* Roommate Needed Badge */}
                                        {listing.type?.toLowerCase() === 'coloc' && (
                                            <div className="absolute top-3 left-3 z-10 bg-green-500 text-white text-[10px] font-black uppercase tracking-wider px-3 py-1.5 rounded-full shadow-lg border border-green-400 flex items-center gap-1">
                                                <Zap size={10} /> Need Roommate
                                            </div>
                                        )}
                                    ...
                                    <div className="p-4">
                                        ...
                                        {/* Vibe Preview (Bio Snippet) */}
                                        {listing.author?.bio && (
                                            <div className="mb-4 p-3 bg-orange-50/50 rounded-xl border border-orange-100/50 relative">
                                                <p className="text-xs text-gray-600 line-clamp-2 italic">
                                                    <span className="text-orange-300 font-serif text-lg leading-none mr-1">"</span>
                                                    {listing.author.bio}
                                                    <span className="text-orange-300 font-serif text-lg leading-none ml-1">"</span>
                                                </p>
                                            </div>
                                        )}
            ...
            <div className="hidden lg:block lg:flex-1 h-[calc(100vh-64px)] sticky top-0 bg-gray-100 border-l border-gray-200 z-0">
                <ListingsMap
